...
const dictionaries: Record<Language, Record<string, string>> = {
    MGL: {
        ...
        hero_title: "Фитнес төвийнхөө өдөр тутмын үйл ажиллагааг нэг дороос хянаарай.",
        hero_subtitle: "Гишүүнчлэл, төлбөр тооцоо, ирц бүртгэл, хичээлийн хуваарь болон ажилтны удирдлагыг нэг системээс удирдаж, өдөр тутмын үйл ажиллагаагаа илүү хялбар, цэгцтэй, үр ашигтай болгоорой.",
        ...
        unlimited_members: "Гишүүдийн удирдлага",
        qpay_integrated: "Төлбөрийн хяналт",
        local_support: "Ирц, хуваарь",

        dashboard_label: "Бодит цагийн төлөв",
        ...
        next_class_value: "Zumba class",
        payment_queue: "Сул байр",
        payment_queue_value: "14 байр",
        renewal_alerts: "Бүртгэлтэй гишүүд",
    ...
    ENG: {
        ...
        next_class_value: "18:30 Zumba class",
        payment_queue: "Payments to Review",
        payment_queue_value: "14 payments pending",
